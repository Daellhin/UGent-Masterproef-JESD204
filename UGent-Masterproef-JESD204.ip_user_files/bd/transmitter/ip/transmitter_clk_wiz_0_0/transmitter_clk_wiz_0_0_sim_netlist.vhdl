...
-- Date        : Fri Mar 21 10:01:49 2025
-- Host        : G16 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/lorin/git/UGent-Masterproef-JESD204/UGent-Masterproef-JESD204.gen/sources_1/bd/transmitter/ip/transmitter_clk_wiz_0_0/transmitter_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : transmitter_clk_wiz_0_0
...
entity transmitter_clk_wiz_0_0_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1_p : in STD_LOGIC;
    clk_in1_n : in STD_LOGIC
  );
end transmitter_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of transmitter_clk_wiz_0_0_clk_wiz is
  signal clk_in1_transmitter_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_transmitter_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_buf_transmitter_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_transmitter_clk_wiz_0_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkfbout_transmitter_clk_wiz_0_0,
      O => clkfbout_buf_transmitter_clk_wiz_0_0
    );
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_transmitter_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_transmitter_clk_wiz_0_0,
      O => clk_out1
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity transmitter_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1_p : in STD_LOGIC;
    clk_in1_n : in STD_LOGIC
  ...
  attribute NotValidForBitStream of transmitter_clk_wiz_0_0 : entity is true;
end transmitter_clk_wiz_0_0;

architecture STRUCTURE of transmitter_clk_wiz_0_0 is
begin
inst: entity work.transmitter_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1
