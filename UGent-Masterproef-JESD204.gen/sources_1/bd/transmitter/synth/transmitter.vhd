...
architecture STRUCTURE of transmitter is
  ...
  signal device_clk_0_1 : STD_LOGIC;
  ...
  attribute X_INTERFACE_PARAMETER of device_clk : signal is "XIL_INTERFACENAME CLK.DEVICE_CLK, CLK_DOMAIN transmitter_device_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
begin
  SYNC_1 <= SYNC;
  SYSREF_0_1 <= SYSREF;
  device_clk_0_1 <= device_clk;
